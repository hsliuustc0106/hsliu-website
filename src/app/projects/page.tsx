          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {[
              ...
              },
              {
                ...
                desc: 'Earth sciences suite within MindScience supporting multi-temporal-spatial-scale meteorological forecasting. Provides medium-range weather forecasting models with 1000x performance improvement over traditional methods.',
                link: 'https://gitee.com/mindspore/mindscience',
                category: 'AI4Science',
                features: [
              ...
              },
              {
                ...
                desc: 'CFD solver suite supporting AI fluid simulation driven by physics, data, and data-mechanism fusion. Interfaces with domestic CFD solver PHengLei and includes built-in differentiable CFD solver.',
                link: 'https://gitee.com/mindspore/mindscience',
                category: 'AI4Science',
                features: [
                  ...
                  'End-to-end flow field simulation'
                ],
                tech: ['CFD', 'Physics-Informed NNs', 'Differentiable Programming', 'Fluid Dynamics']
              },
              {
                title: 'MindSPONGE - Computational Biology',
                desc: 'Computational biology toolkit supporting high-performance, modular, end-to-end differentiable, AI-native architecture for molecular simulation, protein folding, and NMR data analysis.',
                link: 'https://gitee.com/mindspore/mindscience',
                category: 'AI4Science',
                features: [
